...
<div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
    <header className="p-6 shadow-lg bg-gray-950">
        <div className="container mx-auto flex justify-between items-center">
            <h1 className="text-3xl font-bold">Tatiana's Tech Vision</h1>
            <nav>
    ...
    <main className="container mx-auto px-4">
        ...
        <section className="text-center py-20" id="hero">
            <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                ...
                Bringing Your Ideas to Life with Cutting-Edge Software Solutions
                </p>
        ...
        {/* Projects Section */}
        {/*<section className="py-20" id="projects" display="none">
        ...
        <section className="py-20 bg-gray-950" id="contact">
            ...
            <p className="text-lg text-center space-y-6 pb-6">
                If you have any questions or would like to work together, feel free to reach out!
            </p>
            
            <form action="https://formspree.io/f/xyzyqqap" method="POST" className="max-w-xl mx-auto space-y-6">
                <div>
                ...
                <div>
                    ...
                    <input type="email" id="email" name="_replyto" className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white focus:ring focus:ring-blue-500" />
                </div>
                <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="email">Subject</label>
                    <input type="subject" id="subject" className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white focus:ring focus:ring-blue-500" />
                </div>
                <div>
    ...
    <footer className="py-6 text-center bg-gray-950">
        <p>&copy; 2025 Tatiana's Tech Vision. All rights reserved.</p>
    </footer>
</div>
